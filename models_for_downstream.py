...
class MultiModalEncoderDecoder(nn.Module):
    def __init__(self, ckpt_path, num_classes, pool_type="avgmax"):
        super().__init__()
        ...
        print("Models init successfully.")
        ...
        print("Load pre-trained parameters from {} successfully.".format(ckpt_path))
